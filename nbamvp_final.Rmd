...
An interesting application of this may be in the MVP and All-star selections, where players are chosen based off of voting systems associated with media spectators and individual ones. One question is whether we might be able to use machine learning to predict how voters chose 
