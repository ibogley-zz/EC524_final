...
NOTE: New Orleans Pelicans used to be the Hornets from 2002-2013, and were located in OKC from 2005-2007
Some teams changed their team name or location during our current timeframe, I argue we might as well remove team from our predictions.
```{r elasticnet}
set.seed(8237)
